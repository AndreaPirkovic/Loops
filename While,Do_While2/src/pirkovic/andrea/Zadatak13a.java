...
public class Zadatak13a { public static void main(String[] args) throws Exception { 
	...
	while (Math.abs(x1 - x0) > eps || Math.abs(y1 - y0) > eps) { x0 = x1; x1 = 0.5 * Math.sqrt(x0 * (3 * y0 - 1) + 1); y0 = y1; y1 = Math.sqrt((x0 + 3) / 2); } 
